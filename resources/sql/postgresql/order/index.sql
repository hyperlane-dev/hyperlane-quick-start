...
CREATE INDEX IF NOT EXISTS idx_order_record_image_record_id ON order_record_image (record_id);

CREATE INDEX IF NOT EXISTS idx_order_record_image_user_id ON order_record_image (user_id);